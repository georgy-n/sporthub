...
//import http.modules.{HttpModule, ReqCompleter, _}
...
//import http.AppHttp._
//import tethys.JsonObjectWriter
//import tethys.derivation.semiauto.{jsonReader, jsonWriter}
//
//final class SystemModule[F[_] : Sync , Http[_] : Monad : RoutedPlus : LiftHttp[*[_], F] : ReqCompleter](
...
//  val startTime      = ZonedDateTime.now().format(DateTimeFormatter.ofPattern("YYYYMMdd_hhmmss"))
